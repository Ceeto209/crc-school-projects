// Name: Israel Vasquez
// Assignment#: A6
// File Name: BasePlusCommissionEmployee.cs
// Purpose: Represents a base plus commission employee, derived from CommissionEmployee.
...
public class BasePlusCommissionEmployee : CommissionEmployee
{
   ...
   public BasePlusCommissionEmployee(string firstName, string lastName,
      string socialSecurityNumber, int month, int day, int year, decimal grossSales, decimal commissionRate, decimal baseSalary)
