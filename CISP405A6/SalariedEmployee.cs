...
// Purpose: Represents a salaried employee, derived from Employee.
...
public class SalariedEmployee : Employee
{
    ...
    // Constructor
    public SalariedEmployee(string firstName, string lastName, string socialSecurityNumber, int month, int day, int year, decimal weeklySalary): 
